...
const ExitRoom = ({closeExitModal, onExitRoom}) => {
        ...
        <View style={styles.globalContainer}>
            <View style={styles.modalContainer}>
                ...
                <View style={styles.messageContainer}>
                    <Text style={styles.message}>Do you want to leave the room?</Text>
                </View>

                <View style={styles.confirmButtonContainer}>
                    <TouchableOpacity style={styles.confirmButton} onPress={ () => onExitRoom()}>
                        <Text style={styles.confirmButtonLabel}>Yes</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.confirmButton} onPress={ () => closeExitModal()}>
