...
const ShowAnswer = ({answer, closeShowAnswer}) => {
        ...
        <View style={styles.globalContainer}>
            <View style={styles.modalContainer}>
                ...
                <View style={styles.messageContainer}>
                    <Text style={styles.message}>The Answer was :</Text>
                    <Text style={styles.answerText}>"{answer}"</Text>
                </View>

                <View style={styles.confirmButtonContainer}>
                    <TouchableOpacity style={styles.confirmButton} onPress={ () => closeShowAnswer()}>
                        <Text style={styles.confirmButtonLabel}>OK</Text>
                    </TouchableOpacity>
                </View>
